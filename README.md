...
从 GitHub Release 下载 `dongv-ui-system-1.2.6.tgz`，然后安装：

```bash
npm install ./dongv-ui-system-1.2.6.tgz
```

也可直接安装公开 Release：

```bash
npm install https://github.com/dongV-x/dongV-UI-system/releases/download/v1.2.6/dongv-ui-system-1.2.6.tgz
```
