...
function Demo() {
  ...
  return <main className="demo-shell">
    ...
    <section className="demo-panel"><h2>表格安全边距</h2><div className="demo-table-wrap"><DataTable density="standard"><thead><tr><th>对象</th><th>状态</th><th>负责人</th><th>更新时间</th></tr></thead><tbody><tr><td>示例商品 A</td><td><StatusBadge tone="success">正常</StatusBadge></td><td>成员甲</td><td>今天</td></tr><tr><td data-vertical-align="top"><strong>示例商品 B</strong><small className="demo-cell-meta">SKU-002 · 多行内容显式顶部对齐</small></td><td><StatusBadge tone="warning">关注</StatusBadge></td><td>成员乙</td><td>昨天</td></tr></tbody></DataTable></div></section>
    <section className="demo-panel"><h2>页面状态四档</h2><div className="demo-states"><LoadingState scope="inline">正在更新</LoadingState><EmptyState scope="table">暂无符合条件的数据</EmptyState><EmptyState>暂无内容</EmptyState><ErrorState scope="page"><strong>页面暂时没有打开</strong><button type="button">重新加载</button></ErrorState></div><Toast>保存成功</Toast></section>
